...
-   A JSON-LD structure style also could be generated by the function with click the check box `JSON-LD` to enable it. With same input above, the result of using JSON-LD style let users understand arguments easier and it is like:
