...
# sum_str(path_in = "example-1.R", dir_in = "tests/testthat/raw_in", granularity = 3,
# dir_out = "tests/testthat/correct", file_out = "out-ex-1_gran-3", title = FALSE)
  ...
  test    <- sum_str(path_in = paste0(path_start, "raw_in/example-1.R"), dir_out = "", granularity = 3,
...
# sum_str(path_in = "example-1.R", dir_in = "tests/testthat/raw_in", granularity = 2,
# dir_out = "tests/testthat/correct", file_out = "out-ex-1_gran-2", title = FALSE)
  ...
  test    <- sum_str(path_in = paste0(path_start, "raw_in/example-1.R"), dir_out = "", granularity = 2,
                     file_out = "object", last_sep = TRUE, title = FALSE)[[1]]
  expect_identical(correct, test)
...
### .. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
### check for granularity == 2
  # sum_str(path_in = "example-1.R", dir_in = "tests/testthat/raw_in", granularity = 1,
  ...
  test    <- sum_str(path_in = paste0(path_start, "raw_in/example-1.R"), dir_out = "", granularity = 1,
                     file_out = "object", last_sep = TRUE, title = FALSE)[[1]]
  expect_identical(correct, test)
...
test_that("granularity example-2", {
  # create originals
  # mapply(sum_str,
  #        path_in = "example-2.R", dir_in = "tests/testthat/raw_in",
...
### check for granularity == 3
  ...
  test    <- sum_str(path_in = paste0(path_start, "raw_in/example-2.R"), dir_out = "", granularity = 3,
                     file_out = "object", last_sep = TRUE, title = FALSE)[[1]]
  expect_identical(correct, test)
...
### check for granularity == 2
  ...
  test    <- sum_str(path_in = paste0(path_start, "raw_in/example-2.R"), dir_out = "", granularity = 2,
                     file_out = "object", last_sep = TRUE, title = FALSE)[[1]]
  expect_identical(correct, test)
...
### check for granularity == 2
  ...
  test    <- sum_str(path_in = paste0(path_start, "raw_in/example-2.R"), dir_out = "", granularity = 1,
                     file_out = "object", last_sep = TRUE, title = FALSE)[[1]]
  expect_identical(correct, test)
...
test_that("granularity example-3", {
  # create originals
  # mapply(sum_str,
  #        path_in = "example-3.R", dir_in = "tests/testthat/raw_in",
  #        dir_out = "tests/testthat/correct", title = FALSE,
  #        granularity = 3:1,
...
### check for granularity == 3
  ...
  expect_warning(test <- sum_str(path_in = paste0(path_start, "raw_in/example-3.R"), dir_out = "", granularity = 3,
                     file_out = "object", last_sep = TRUE, title = FALSE)[[1]])
  expect_identical(correct, test)
...
### check for granularity == 2
  ...
  expect_warning(test <- sum_str(path_in = paste0(path_start, "raw_in/example-3.R"), dir_out = "", granularity = 2,
                     file_out = "object", last_sep = TRUE, title = FALSE)[[1]])
  expect_identical(correct, test)
...
# level does not exist:
  expect_warning(sum_str(path_in = paste0(path_start, "raw_in/example-3.R"), dir_out = "", granularity = 1,
...
# mapply(sum_str,
#        path_in = "example-4.R", dir_in = "tests/testthat/raw_in",
#        dir_out = "tests/testthat/correct", title = FALSE,
#        granularity = 3:1,
...
test_that("granularity 4", {
  ...
  expect_warning(test <- sum_str(path_in = paste0(path_start, "raw_in/example-4.R") , dir_out = "", granularity = 3,
                     file_out = "object", last_sep = TRUE, title = FALSE)[[1]])
  expect_identical(correct, test)
...
### check for granularity == 2
  ...
  expect_warning(test    <- sum_str(path_in = paste0(path_start, "raw_in/example-4.R"), dir_out = "", granularity = 2,
                     file_out = "object", last_sep = TRUE, title = FALSE)[[1]])
  expect_identical(correct, test)
...
### check for granularity == 1
  ...
  expect_warning(test  <- sum_str(path_in = paste0(path_start, "raw_in/example-4.R"), dir_out = "", granularity = 1,
                     file_out = "object", last_sep = TRUE, title = FALSE)[[1]])
  expect_identical(correct, test)
...
# generate samples
# mapply(sum_str, path_in = paste0("example-", rep(1:5, each = 3), ".R"),
...
test_that("example-3-and-4", {
  ...
  for (i in 1:3) {
    for (j in c(1, 2, 5)) {
      ...
      test    <- sum_str(path_in = paste0(path_start, "raw_in/example-", j, ".R"), dir_out = "", granularity = i,
