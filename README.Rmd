...
- An [RStudio Add-in](https://rstudio.github.io/rstudioaddins/) that lets you 
  quickly add code block separators and titles to divide your work into sections.
...
* Every title ends with four `####`. Therefore, the titles are recognized 
  ...
  by Rstudio and you can fold sections as you can fold 
...
A code anchor is a hash sequence that can be used to create an arguably unique
reference in a code base.
`strcode` helps you inserting such anchors easily. By default, 
a code anchor is enclosed by `#<` and `>#` so all anchors can be found 
using regular expressions. An example of a code anchor is the following:
