...
option `strcode.char.lenght` and can be changed by the user (either every 
session manually or using .Rprofile). \
For each of the introduced separator, there is an Add-in function. You can also call 
