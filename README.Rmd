...
The strcode (short for structure code) package is an 
...
better. You can learn more about structuring code in 
[Bono Usu](https://github.com/lorenzwalthert/bonousu/blob/devel/docs/commenting-code.html), 
...
* The breaks characters `___`, `...`, `. .` were choosen such that they reflect the level 
...
# Example
To demonstrate the improvement to legibility, we give an extended example of 
garbage code.
```{r}
#   ____________________________________________________________________________
#   function test 
